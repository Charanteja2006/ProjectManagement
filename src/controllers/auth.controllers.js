...
const resendEmailVerification = asyncHandler(async (req,res) =>{
    ...
    return res
        .status(200)
        .json(new ApiResponse(200,{},"Email verification token sent successfully. Please check your email."))
})
...
const forgotPasswordRequest = asyncHandler(async (req,res) =>{
   ...
   user.forgotPasswordToken = hashedToken;
    ...
    return res
        .status(200)
        .json(new ApiResponse(200,{},"Password reset email sent successfully. Please check your email."));
})
